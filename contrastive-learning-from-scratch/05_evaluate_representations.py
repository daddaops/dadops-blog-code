...
if __name__ == "__main__":
    ...
    # Evaluate BEFORE training (random encoder)
    print("Before training (random encoder):")
    random_encoder = SimCLREncoder(input_dim=2, hidden_dim=8, proj_dim=4)
    evaluate_representations(data, labels, random_encoder)
    ...
    evaluate_representations(data, labels, encoder)
